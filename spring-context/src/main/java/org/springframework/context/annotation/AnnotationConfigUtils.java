...
public abstract class AnnotationConfigUtils {
	...
	public static Set<BeanDefinitionHolder> registerAnnotationConfigProcessors(
		...
		/**
		 * 注册用于处理 @Configuration注解的处理器: {@link ConfigurationClassPostProcessor}
		...
		/**
		 * 注册用于处理 @Autowired注解的处理器：{@link AutowiredAnnotationBeanPostProcessor}
		...
		/**
		 * 注册用于处理 JSR-250 注解的处理器：{@link CommonAnnotationBeanPostProcessor}
		 * bean name: org.springframework.context.annotation.internalCommonAnnotationProcessor
		 * 
		 * JSR-250注解，包括@PostConstruct，@PreDestroy和@Resource
		 */
		...
		/**
		 * 用于处理JPA注解相关的处理器： PersistenceAnnotationBeanPostProcessor
		...
		/**
		 * 注册用于@EventListener 注解的处理器：{@link EventListenerMethodProcessor}
		...
		/**
		 * 注册用于处理 EventListenerFactory 的处理器：DefaultEventListenerFactory
